              ...
              SliverAppBar(
                ...
                actions: [
                  Padding(
                    ...
                    child: IconButton(
                      // UPDATED: Added async and refresh logic here
                      onPressed: () async {
                        // 1. Wait until the user pops the Settings screen
                        await Navigator.pushNamed(context, AppRoutes.settings);
                        
                        // 2. Force Firebase to fetch the latest profile data
                        await FirebaseAuth.instance.currentUser?.reload();
                        
                        // 3. Trigger a rebuild to reflect the new data (name, photo, etc.)
                        if (mounted) {
                          setState(() {});
                        }
                      },
