...
void dispose() {
  ...
  onPressed: () async {
    if (_heightController.text.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter your height first.'),
  ...
  setState(() {
    _chestController.text = result['chest']!.toStringAsFixed(1);
    _waistController.text = result['waist']!.toStringAsFixed(1);
    _hipsController.text = result['hips']!.toStringAsFixed(1);
    _measurementMethod = 'ai_scan';
  });
